...
```php
'to_email'   => 'contact@votre-domaine.fr',   // ← où arrivent les demandes
'from_email' => 'no-reply@votre-domaine.fr',  // ← adresse OVH réelle (voir note)
'method'     => 'smtp',                        // 'smtp' (recommandé) ou 'mail'
'smtp' => [
    'host'       => 'ssl0.ovh.net',
    'port'       => 587,
    'encryption' => 'tls',
    'username'   => 'no-reply@votre-domaine.fr', // = une adresse email OVH
...
> exemple `no-reply@votre-domaine.fr` dans votre espace client OVH, puis
...
1. **Personnaliser** avant mise en ligne :
   ...
   - Email affiché : `contact@exemple-keitel.fr`
   - URL du site : `www.exemple-keitel.fr` (balises canonical, Open Graph, schema.org)
